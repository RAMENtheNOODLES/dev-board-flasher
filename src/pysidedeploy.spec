...
# python path
python_path = c:\projects\dev-board-flasher\.venv\Scripts\python.exe
...
modules = Core,Gui,SerialPort,Widgets
...
extra_args = --quiet --noinclude-qt-translations --windows-console-mode=disable --include-data-dir=config=config --include-data-files=pyproject.toml=pyproject.toml --include-package-data=certifi --assume-yes-for-downloads
