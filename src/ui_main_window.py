...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpen_File.setStatusTip(QCoreApplication.translate("MainWindow", u"Open file from disk.", None))
...
#if QT_CONFIG(statustip)
        self.actionCheck_for_Updates.setStatusTip(QCoreApplication.translate("MainWindow", u"Check for any application updates.", None))
#endif // QT_CONFIG(statustip)
        self.action_Reload_App.setText(QCoreApplication.translate("MainWindow", u"&Reload App", None))
#if QT_CONFIG(statustip)
        self.action_Reload_App.setStatusTip(QCoreApplication.translate("MainWindow", u"Reload the application.", None))
#endif // QT_CONFIG(statustip)
        self.actionGithubPAT.setText(QCoreApplication.translate("MainWindow", u"&Github Personal Access Token...", None))
#if QT_CONFIG(statustip)
        self.actionGithubPAT.setStatusTip(QCoreApplication.translate("MainWindow", u"Set a Github Personal Access Token.", None))
#endif // QT_CONFIG(statustip)
        self.actionRemote_Configurations.setText(QCoreApplication.translate("MainWindow", u"Remote &Configurations...", None))
#if QT_CONFIG(statustip)
        self.actionRemote_Configurations.setStatusTip(QCoreApplication.translate("MainWindow", u"Setup remote configurations.", None))
#endif // QT_CONFIG(statustip)
        self.actionCANLib_Kvaser.setText(QCoreApplication.translate("MainWindow", u"&CAN", None))
#if QT_CONFIG(statustip)
        self.actionCANLib_Kvaser.setStatusTip(QCoreApplication.translate("MainWindow", u"Open CAN Viewer.", None))
#endif // QT_CONFIG(statustip)
        self.action_Elf_Parser.setText(QCoreApplication.translate("MainWindow", u"&Elf Parser", None))
#if QT_CONFIG(statustip)
        self.action_Elf_Parser.setStatusTip(QCoreApplication.translate("MainWindow", u"Open ELF Parser.", None))
#endif // QT_CONFIG(statustip)
        self.action_About.setText(QCoreApplication.translate("MainWindow", u"&About", None))
#if QT_CONFIG(statustip)
        self.action_About.setStatusTip(QCoreApplication.translate("MainWindow", u"Open about menu.", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.action_Invalidate_Cache.setStatusTip(QCoreApplication.translate("MainWindow", u"Invalidate stored cache.", None))
#endif // QT_CONFIG(statustip)
        self.action_Preferences.setText(QCoreApplication.translate("MainWindow", u"&Preferences...", None))
#if QT_CONFIG(statustip)
        self.action_Preferences.setStatusTip(QCoreApplication.translate("MainWindow", u"Open preferences menu.", None))
#endif // QT_CONFIG(statustip)
        self.action_A2L_Parser.setText(QCoreApplication.translate("MainWindow", u"&A2L Parser", None))
#if QT_CONFIG(statustip)
        self.action_A2L_Parser.setStatusTip(QCoreApplication.translate("MainWindow", u"Open A2L Parser.", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.serialMonitorButton.setStatusTip(QCoreApplication.translate("MainWindow", u"Connect and disconnect to a board using UART.", None))
#endif // QT_CONFIG(statustip)
        self.serialMonitorButton.setText(QCoreApplication.translate("MainWindow", u"Connect", None))
#if QT_CONFIG(statustip)
        self.refreshCOMPortButton.setStatusTip(QCoreApplication.translate("MainWindow", u"Refresh the COM ports.", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.uploadButton.setStatusTip(QCoreApplication.translate("MainWindow", u"Load a file from disk to flash a board.", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.clearLogsButton.setStatusTip(QCoreApplication.translate("MainWindow", u"Clear the logs text box.", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.uploadBoardButton.setStatusTip(QCoreApplication.translate("MainWindow", u"Upload the currently selected file to a connected board.", None))
#endif // QT_CONFIG(statustip)
