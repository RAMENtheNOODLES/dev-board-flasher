...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.versionLabel, 9, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label, 7, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.serialTXBox, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.serialMonitorButton, 8, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sendTXDataButton, 8, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.baudRateBox, 7, 2, 1, 1)
